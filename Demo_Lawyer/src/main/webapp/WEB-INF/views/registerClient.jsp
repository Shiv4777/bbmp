...
<div class="container">
            ...
            <form class="modal-content animate" action="/registerClient" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="address" name="address" placeholder="Please mention Complete Address" class="form-control">
                    </div>
                </div>
                 <div class="form-group">
                        <label for="weight" class="col-sm-3 control-label">Other Details </label>
                    <div class="col-sm-9">
                        <input type="text" id="otherDetails" name="otherDetails" placeholder="Please write any other relevant information" class="form-control">
                    </div>
                </div>
                <!-- /.form-group -->
                <div class="form-group">
